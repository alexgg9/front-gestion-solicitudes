            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <a
                        ...
                        className="cursor-pointer inline-flex items-center px-6 py-4 mt-8 font-semibold text-black transition-all duration-200 bg-yellow-300 rounded-full lg:mt-12 hover:bg-yellow-400 focus:bg-yellow-400"
                        >
                        Regístrate
                        <svg
                        ...
                        <span
                            ...
                            className="cursor-pointer text-black transition-all duration-200 hover:underline"
                        >
                            Inicia sesión
                        </span>
                        </p>
